...
//TODO: переписать с использованием children, nextSiblingElement, table.rows, tr.cells, tr.rowIndex, td.cellIndex и т. п. (в sticky-filter, где не юзаются методы цкедитора)
